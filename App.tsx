...
const App: React.FC = () => {
  ...
  return (
    <div className="relative min-h-screen w-full flex flex-col md:flex-row overflow-hidden bg-matcha selection:bg-retro-orange selection:text-white">
      <GrainOverlay />
      ...
      <main className="flex-1 flex flex-col items-center justify-center p-8 z-10 min-h-[50vh]">
        ...
        <div className="mt-12 text-center max-w-md">
           ...
           <p className="text-charcoal/60 font-mono mt-2 uppercase tracking-widest text-sm">
      ...
      <aside className="w-full md:w-[400px] bg-white/30 backdrop-blur-md border-l border-charcoal/5 p-8 flex flex-col items-center justify-center z-20 gap-8 relative">
        ...
        <div className="flex items-center space-x-4 w-full max-w-[200px]">
           <button onClick={() => setIsMuted(!isMuted)} className="text-charcoal hover:text-retro-orange transition-colors">
           ...
           <input 
             ...
             className="w-full h-1 bg-charcoal/20 rounded-lg appearance-none cursor-pointer [&::-webkit-slider-thumb]:appearance-none [&::-webkit-slider-thumb]:w-3 [&::-webkit-slider-thumb]:h-3 [&::-webkit-slider-thumb]:rounded-full [&::-webkit-slider-thumb]:bg-retro-orange"
           />
        </div>

        {/* Footer Info */}
        <div className="absolute bottom-4 text-[10px] text-charcoal/30 font-mono text-center w-full px-4">
